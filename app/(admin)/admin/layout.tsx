...
const NAV_ITEMS = [{ href: "/admin", label: "控制台" }, { href: "/admin/members", label: "成员管理" }, { href: "/admin/teams", label: "团队管理" }, { href: "/admin/team-points", label: "绩效点管理" }, { href: "/admin/positions", label: "职位管理" }, { href: "/admin/schemes", label: "工资方案" }, { href: "/admin/anchor-revenue", label: "主播流水" }, { href: "/admin/team-review", label: "团队审核" }, { href: "/admin/change-requests", label: "资料审核" }, { href: "/admin/payroll", label: "工资核算" }];
