...
const NAV_ITEMS = [{ href: "/admin", label: "控制台" }, { href: "/admin/employees", label: "员工管理" }, { href: "/admin/teams", label: "团队管理" }, { href: "/admin/positions", label: "职位与权限" }, { href: "/admin/schemes", label: "工资方案" }, { href: "/admin/review", label: "业绩审核" }, { href: "/admin/payroll", label: "工资核算" }];
