...
import { useCreateScheme, useEmployees, usePositions, useSchemes } from "@/lib/api/hooks";
...
export default function SchemesPage() {
  const schemes = useSchemes(); const employees = useEmployees(); const positions = usePositions(); const create = useCreateScheme(); const [show, setShow] = useState(false); const { register, handleSubmit, reset } = useForm<FormValues>();
